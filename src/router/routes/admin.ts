...
export const adminRoutes: RouteRecordRaw = {
    ...
    children: [
        ...
        { path: 'reports', name: 'ReportCenter', component: () => import('../../views/Master/DataCenter/Report.vue'), meta: { title: '報表查詢', center: '報表中心' } },
        ...
        { path: 'merchant/create', redirect: { name: 'merchant-list', query: { create: '1' } } },
        {
            ...
            meta: {
                title: '代理管理',
                center: '商務管理',
                description: '管理既有代理階層、商戶歸屬與核准的商務條件。'
            }
        },
        { path: 'business/contracts', redirect: '/admin/business/agents' },
        { path: 'game-center/providers', name: 'provider-list', component: () => import('../../views/Master/GameCenter/ProviderList.vue'), meta: { title: '供應商管理', center: '廠商管理' } },
        { path: 'game-center/list', name: 'game-center', component: () => import('../../views/Master/GameCenter/GameList.vue'), meta: { title: '遊戲管理', center: '廠商管理' } },
        { path: 'content/campaigns', name: 'Campaigns', component: () => import('../../views/Master/GameCenter/Campaigns.vue'), meta: { title: '獎池與活動', center: '廠商管理' } },
        { path: 'transactions/players', name: 'PlayerManagement', component: () => import('../../views/Master/Transactions/PlayerManagement.vue'), meta: { title: '會員與錢包', center: '商務管理' } },
        ...
        { path: 'finance/provider-accounting', name: 'ProviderAccounting', component: () => import('../../views/Master/Finance/ProviderAccounting.vue'), meta: { title: '供應商對帳', center: '財務中心' } },
        { path: 'finance/agent-accounting', name: 'AgentAccounting', component: () => import('../../views/Master/Finance/AgentAccounting.vue'), meta: { title: '代理對帳', center: '財務中心' } },
        { path: 'finance/merchant-accounting', name: 'MerchantAccounting', component: () => import('../../views/Master/Finance/MerchantAccounting.vue'), meta: { title: '商戶對帳', center: '財務中心' } },
        ...
        { path: 'quality/audit-logs', redirect: '/platform/access/logs' },
        { path: 'system/audit-logs', redirect: '/platform/access/logs' },
        ...
        { path: 'system/staff', redirect: '/platform/access/accounts' },
        { path: 'system/roles', redirect: '/platform/access/roles' },
...
export const platformRoutes: RouteRecordRaw = {
    ...
    children: [
        {
            path: 'access',
            component: () => import('../../views/Master/System/AccessLayout.vue'),
            meta: { title: '人員與權限', center: '系統管理' },
            children: [
                { path: '', redirect: '/platform/access/logs' },
                { path: 'accounts', name: 'AccessAccounts', component: () => import('../../views/Master/System/StaffList.vue'), meta: { title: '後台帳號', center: '人員與權限' } },
                { path: 'roles', name: 'AccessRoles', component: () => import('../../views/Master/System/JobLevelList.vue'), meta: { title: '角色管理', center: '人員與權限' } },
                { path: 'logs', name: 'AccessLogs', component: () => import('../../views/Master/System/AuditLogs.vue'), meta: { title: '操作紀錄', center: '人員與權限' } }
            ]
        }
    ]
}
